...
const MainAppLayout: React.FC<{
    ...
    modifyCalendarEvent: (originalTitle: string, updates: any) => Promise<string>;
    currentTime: Date;
    // AI Chat Props
    aiChat: GenAIChat | null;
    ...
    const { 
        ...
        getStudyPlans, getStudyPlanDetails, deleteStudyPlan, modifyCalendarEvent,
        currentTime, aiChat, aiChatMessages, setAiChatMessages, resetAIChat, chatHistories, currentChatSessionId, setCurrentChatSessionId, onDeleteAllChats, loadChatHistory, triggerHapticFeedback
    } = props;
        ...
        <div className={`flex h-screen w-full`}>
            ...
            {isChatOpen && (
                 <AIChatView
                    ...
                    modifyCalendarEvent={modifyCalendarEvent}
                    tSubject={tSubject}
