...
const AdminFeedbackView: React.FC<AdminFeedbackViewProps> = ({ t, getThemeClasses, showAppModal, user }) => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[70vh]">
            <div className="md:col-span-1 bg-white p-4 rounded-lg shadow-md overflow-y-auto">
            ...
            <div className="md:col-span-2 bg-white p-6 rounded-lg shadow-md flex flex-col">
                {selectedFeedback ? (
                    <>
