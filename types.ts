...
// FIX: The type-only import was preventing React's global JSX namespace from being loaded, which caused all intrinsic elements (div, p, etc.) to be unrecognized.
// Changing to a full import allows for proper declaration merging.
import * as React from 'react';

// FIX: Define the 'lottie-player' custom element globally to prevent TypeScript errors across the app.
// This was moved from WelcomeView.tsx to fix a widespread issue where JSX intrinsic elements were not being recognized.
declare global {
  namespace JSX {
...
// FIX: Renamed 'Chat' to 'UserChatSession' to avoid name collision with the @google/genai 'Chat' type.
